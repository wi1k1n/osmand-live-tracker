<?php
    ...
    $data = array(
        'lat' => isset($_GET['key']) ? "'".floatval($_GET['lat'])."'" : 'NULL',
    ...
    $query = "INSERT INTO `osmand_online`(`timestamp_server`, `timestamp_log`, `lat`, `lon`, `hdop`, `altitude`, `speed`, `sender`) VALUES(current_timestamp(), ".$data['timestamp'].", ".$data['lat'].", ".$data['lon'].", ".$data['hdop'].", ".$data['altitude'].", ".$data['speed'].", ".$data['sender'].")";
